...
namespace ProyectoFinal.Context
{
    public partial class EduAsyncHubContext : DbContext
    {
        ...
        public virtual DbSet<CalendarioEspecifico> CalendarioEspecificos { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("CalendarioEspecifico");
            ...
            modelBuilder.Entity<SolicitudAdmision>(entity =>
            {
                ...
                entity.Property(e => e.DireccionPadreTutor)
                    .HasMaxLength(255)
                    .IsUnicode(false);

                entity.Property(e => e.EscuelaActual)
                    .HasMaxLength(100)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.NotasComentarios).HasColumnType("text");

                entity.Property(e => e.NumeroTelefono)
                    .HasMaxLength(20)
                    .IsUnicode(false);

                entity.Property(e => e.RelacionEstudiante)
                    .HasMaxLength(100)
                    .IsUnicode(false);
            });
